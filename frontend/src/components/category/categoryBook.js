    ...
    <>
      ...
      <div className={classes.categoryContainer}>
        <div className={classes.categoryTile}>
          <Link to='/filtered-products?category=Fantasy&type=Book' className={classes.categoryTileLink}>
        ...
        <div className={classes.categoryTile}>
          <Link to='/filtered-products?category=Horror&type=Book' className={classes.categoryTileLink}>
            <img src={img} alt="Category Image" className={classes.categoryTileImage} />
            <p>Horror</p>
          </Link>
        </div>
        <div className={classes.categoryTile}>
          <Link to='/filtered-products?category=Science fiction&type=Book' className={classes.categoryTileLink}>
            <img src={img} alt="Category Image" className={classes.categoryTileImage} />
            <p>Science fiction</p>
          </Link>
        </div>
